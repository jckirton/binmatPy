...
- [BINMAT - The Human Compatible Rulebook](#binmat---the-human-compatible-rulebook)
  - [Index](#index)
  ...
  - [Gameplay](#gameplay)
    ...
    - [Playing a Card](#playing-a-card)
      - [Special Rules: BREAK (\>)](#special-rules-break-)
      - [Special Rules: BOUNCE (?)](#special-rules-bounce-)
    - [Combat](#combat)
